...
<html lang="en">
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      ...
      <!-- logo -->
      <a class="navbar-brand" href="#">OMIAN</a>
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Mensages de rutas rapidas cuadritos de colores -->
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <div class="card mb-3">
              ...
              <div class="card-footer small text-muted">
                Actualizado ayer alas 11:59 PM
              </div>
            </div>

            <!-- Card Columns Example Social Feed -->
            <!-- ejemplos de las redes sociale -->
            <div class="mb-0 mt-4">
            ...
            <div class="card-columns">
              ...
              <!-- Example Social Card --><!-- redes sociales -->
              <div class="card mb-3">
                <a href="#">
